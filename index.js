...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Njabulo_Jb', "safari", "1.0.0"],
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            ...
            for (let membre of membres) {
                msg += ` Hey 🖐️ @${membre.split("@")[0]} welcome to group.`;
            }

            msg += `reald the group description to avoid getting removed`;
