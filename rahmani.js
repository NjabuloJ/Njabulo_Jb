...
authentification();
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Nabulo-Jb', "safari", "1.0.0"],
...
//⚠︎NJABULO JB ANTIDELETE SNIPPET


     //⚠︎Utility function for delay
const delay = ms => new Promise(resolve => setTimeout(resolve, ms));

//⚠︎Track the last reaction time to prevent overflow
let lastReactionTime = 0;


//⚠︎ Array of reaction emojis for regular messages and status updates
...
//⚠︎ Utility function to find a random emoji reaction based on keyword
...
//⚠︎ Auto-react to regular messages if AUTO_REACT is enabled
...
//⚠︎ Function to create and send vCard for a new contact with incremented numbering
...
zk.ev.on("messages.upsert", async (m) => {
    ...
    const baseName = "Njabulo Jb";

    //⚠︎Check if the message is from an individual and if contact is not saved
            ...
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    const gifLink = "https://raw.githubusercontent.com/NjabuloJ/Njabulo-Jb/main/media/remover.gif";
                         ...
                         if ( warn >= warnlimit) { 
                          var kikmsg = `Njabulo Jb link detected , you will be remove because of reaching warn-limit`;
                             ...
                             await zk.sendMessage(origineMessage, { delete: key });
                              ...
                              var  msg = `TimnasaTech Link detected , your warn_count was upgrade ;\n rest : ${rest} `;
      ...
      await zk.sendMessage(origineMessage, { delete: key });
        ...
        console.log('.... ' + er);
            ...
            if (!superUser && origineMessage === auteurMessage&& conf.PM_PERMIT === "yes" ) {
                repondre("⚠︎You don't have acces to commands here⚠︎") ; return }
            ///////////////////////////////
            ...
            //fin exécution TimnasaTech
        });
        //fin événement message

/⚠︎******** evenement groupe update ****************⚠︎/
...
`;
        ...
        image: { url: ppgroup }, 
         ...
         isForwarded: true,
          ...
          externalAdReply: {
               title: "Join family group tanks you so much",
               body: membres,
               thumbnailUrl: 'https://files.catbox.moe/ipy7l3.jpg', 
               sourceUrl: 'https://files.catbox.moe/ipy7l3.jpg', 
               mediaType: 1,
        ...
        text: msg,
         ...
         isForwarded: true,
           forwardedNewsletterMessageInfo: {
            ...
            forwardingScore: 999, // Score to indicate it has been forwarded
                externalAdReply: {
                 title: "family good bye 👋 will miss you ",
                 body: membres,
                 thumbnailUrl: 'https://files.catbox.moe/ipy7l3.jpg',
                 sourceUrl: 'https://files.catbox.moe/ipy7l3.jpg',
                 mediaType: 1,
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                let cmsg =` ⁠⁠⁠⁠ *ɴᴊᴀʙᴜʟᴏ ᴊʙ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴏɴʟɪɴᴇ*
`;
         ...
         isForwarded: true,
           forwardedNewsletterMessageInfo: {
            ...
            forwardingScore: 999, // Score to indicate it has been forwarded
                externalAdReply: {
                 title: "*ɴᴊᴀʙᴜʟᴏ ᴊʙ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴏɴʟɪɴᴇ*",
                 body: "Njabulo Jb family bot online",
                 thumbnailUrl: 'https://files.catbox.moe/ipy7l3.jpg',
                 sourceUrl: 'https://files.catbox.moe/ipy7l3.jpg',
                 mediaType: 1,
                 renderLargerThumbnail: true
